          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            >
              <div className="relative w-full overflow-hidden rounded-3xl group cursor-pointer">
                <div className="absolute inset-0 border-2 border-navy-500/50 rounded-3xl transform rotate-2 opacity-50 transition-transform duration-500 ease-out group-hover:rotate-0" />
                <img
