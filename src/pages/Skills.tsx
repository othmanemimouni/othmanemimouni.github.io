    ...
    <div className="min-h-screen pt-20 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-navy-600 mt-4 text-lg tracking-wide">Tools and technologies I work with</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-navy-700 text-lg max-w-2xl mx-auto leading-relaxed">
            I'm currently building my skills section to showcase my technical expertise,
            programming languages, frameworks, and tools. Check back soon to see my full tech stack.
          </p>
